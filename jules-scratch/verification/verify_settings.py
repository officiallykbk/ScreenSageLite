...
def run():
    with sync_playwright() as p:
        ...
        settings_link = page.get_by_title("Settings")
        settings_link.click()

        # Wait for the settings page to load
        page.wait_for_url(f'chrome-extension://{extension_id}/popup/settings.html')

        # Take a screenshot
        screenshot_path = 'jules-scratch/verification/settings-page.png'
