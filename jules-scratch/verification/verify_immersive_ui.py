...
def run():
    with sync_playwright() as p:
        ...
        # Take a screenshot of the initial immersive view
        page.screenshot(path="jules-scratch/verification/immersive_compact_view.png")
        ...
        # Take a screenshot of the expanded immersive view
        page.screenshot(path="jules-scratch/verification/immersive_expanded_view.png")
